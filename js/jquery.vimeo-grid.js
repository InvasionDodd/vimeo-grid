    ...
    return this.each(function() {
      ...
      function createGrid() {
        ...
        for (var i = 0; i < totalSquareAmount; i++) {
          ...
          if (i < vidObArray.length) {
            $('#vidThumb_' + vidObArray[i].id).css({
              'position': 'absolute',
              'width': spaceX + 'px',
              'height': spaceY + 'px',
              'left': (colInc * spaceX) + 'px',
              'top': (rowInc * spaceY) + 'px'
            });
          } else {
            $('#vidThumb' + (i + 1)).css({
              'position': 'absolute',
      ...
      function vidThumbOver(e) {
        $(this).find('.videoInfoBlock').stop().animate({
          opacity: 1.00
        }, 300);
      }
      ...
      function openVideo() {
        ...
        $('#videoBox').stop().delay(300).animate({
          opacity: 1.00
        }, 300);
